...
pub(crate) mod test_utils {
    ...
    pub(crate) trait IntoProtocolReader {
        type T: ProtocolReader;
        fn into_protocol_reader(self) -> Self::T;
    }

    impl IntoProtocolReader for BytesMut {
    ...
    impl ProtocolReader for BytesMutReader {
        fn debug_buffer(&self) {
            todo!()
        }
