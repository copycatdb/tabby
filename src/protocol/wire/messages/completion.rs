use crate::{Error, MessageKind, ProtocolReader, protocol::wire::Encode};
...
pub struct CompletionMessage {
    status: BitFlags<CompletionStatus>,
    cur_cmd: u16,
    done_rows: u64,
}
...
impl Encode<BytesMut> for CompletionMessage {
    fn encode(self, dst: &mut BytesMut) -> crate::Result<()> {
        dst.put_u8(MessageKind::Done as u8);
...
impl fmt::Display for CompletionMessage {
