...
pub(crate) struct BytesMutWithDataColumns<'a> {
    ...
    data_columns: &'a Vec<ColumnDescriptor<'a>>,
}

impl<'a> BytesMutWithDataColumns<'a> {
    pub fn new(bytes: &'a mut BytesMut, data_columns: &'a Vec<ColumnDescriptor<'a>>) -> Self {
    ...
    pub fn data_columns(&self) -> &'a Vec<ColumnDescriptor<'a>> {
        self.data_columns
    }
}
